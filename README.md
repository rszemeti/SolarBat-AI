...
2. **Solax ModBus Integration** (or compatible inverter integration)
...
- **Inverters**: 
  - Solax (via solax_modbus) ✅ Fully tested
  - Other inverters may work if they provide similar sensors
...
1. **Pre-emptive Discharge** - If solar will be wasted, discharge battery in cheap morning periods
